    ...
    const marqueeRows = [
        {
            direction: 'forward',
            skills: [
                { name: 'Python', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg', category: 'Languages', level: 'Expert', experience: '2+ Years', description: 'Primary backend language. FastAPI/Django development, RBAC, payment integrations and scalable API design at Codeholic IT Service.' },
                ...
                { name: 'Django', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/django/django-plain.svg', category: 'Backend', level: 'Advanced', experience: '1+ Years', description: 'Django for CRM, inventory and enterprise modules with ORM optimization and secure auth.' },
                { name: 'Java', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg', category: 'Languages', level: 'Advanced', experience: '4+ Years', description: 'Object-oriented programming, Spring Boot basics and enterprise logic.' },
        ...
        },
        {
            direction: 'reverse',
            skills: [
                { name: 'React', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg', category: 'Frontend', level: 'Advanced', experience: '1+ Years', description: 'React for frontend integration with backend APIs, component architecture and state handling.' },
        ...
        },
        {
            direction: 'forward',
            skills: [
                { name: 'PostgreSQL', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg', category: 'Database', level: 'Expert', experience: '3+ Years', description: 'Schema design and complex query optimization for enterprise workloads.' },
                { name: 'MySQL', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg', category: 'Database', level: 'Advanced', experience: '3+ Years', description: 'Relational DB management, joins and query tuning for CRM/e-commerce.' },
                { name: 'MongoDB', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-original.svg', category: 'Database', level: 'Advanced', experience: '1+ Years', description: 'NoSQL design for flexible document storage and product catalogs.' },
